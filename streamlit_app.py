...
faq = {
    ...
    ":small_blue_diamond: Dimitar shte vzeme li pari ot taq rabota? :arrow_down_small: " : "Moje da mu sa iska mnogo, ama nqma. :no_pedestrians:  Az sam si sa potrudih za tozi website i si e vsi4ko za men. :shark: ",
